    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('bookings.store') }}" method="POST" id="createForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('guest_address') is-invalid @enderror"
                                              id="guest_address" name="guest_address" rows="2">{{ old('guest_address') }}</textarea>
                                    @error('guest_address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="card bg-light">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <p><strong>Total Nights:</strong> <span id="total_nights">0</span></p>
                                            </div>
                                            <div class="col-md-4">
                                                <p><strong>Room Price:</strong> $<span id="room_price">0.00</span>/night</p>
                                            </div>
                                            <div class="col-md-4">
